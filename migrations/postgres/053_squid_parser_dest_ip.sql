-- ============================================================================
-- Migration 053: Update Squid Proxy parser to set dest_ip for IP-based URLs
-- ============================================================================
-- When the URL contains an IP address (e.g., http://185.220.101.35/path),
-- the parser now sets dest_ip in addition to dest_host. This enables
-- prevalence lookups for IP-based destinations via prevalence_dest_ip.
-- ============================================================================

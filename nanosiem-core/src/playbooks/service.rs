...
impl PlaybookService {
    ...
    pub async fn list(
        ...
        let playbooks = self.repo.list(query).await?;
    ...
    pub async fn list_by_signal(&self, signals: &[String]) -> Result<Vec<Playbook>, PlaybookError> {
        self.repo.list_by_signal(signals).await
    }
    ...
    pub async fn update(
        ...
        self.repo.update(id, &req, parsed.as_ref(), user_id).await
    }
    ...
    pub async fn fork(
        ...
        self.repo.fork(id, &req, user_id).await
    }
    ...
    pub async fn list_versions(&self, id: Uuid) -> Result<Vec<PlaybookVersion>, PlaybookError> {
        // Validate playbook exists first for a clean 404.
    ...
    pub async fn list_permissions(
        ...
        let _ = self.repo.get(id).await?;
        self.repo.list_permissions(id).await
    }
    ...
    pub async fn list_approvals(
        ...
        let _ = self.repo.get(id).await?;
        self.repo.list_approvals(id).await
    }
    ...
    pub async fn suggest_for_rule(
        ...
        let rows = self.repo.suggest_by_signals(&signals, category).await?;
    ...
    pub async fn finish_run(
        ...
        self.repo
            .finish_run(run_id, req.outcome, step_completion)
            .await
    }

    /// Surface a run by id (used by case views).
    ...
    pub async fn resolve_run(
        ...
        let doc = self
            .repo
            .get_version_doc(run.playbook_id, run.playbook_version)
            .await?;
    ...
    /// List all playbook runs attached to a case.
    pub async fn list_runs_for_case(
        &self,
        case_id: Uuid,
    ) -> Result<Vec<PlaybookRun>, PlaybookError> {
        self.repo.list_runs_for_case(case_id).await
    }
    ...
    pub async fn promote(
        ...
        self.repo
            .promote(playbook_id, promoted_by_user_id, promoted_by_name)
            .await
    }
    ...
    pub async fn submit_for_review(
        ...
        self.repo
            .submit_for_review(playbook_id, requester_id, req.approver_id, req.message)
            .await
    }
    ...
    pub async fn approve(
        ...
        self.repo
            .approve_approval(approval_id, approver_id, response)
            .await
    }
    ...
    pub async fn reject(
        ...
        self.repo
            .reject_approval(approval_id, approver_id, response)
            .await
    }
    ...
    pub async fn delete_permission(
        ...
        self.repo.delete_permission(playbook_id, role).await
    }
    ...
    pub async fn compute_analytics(
        ...
        // Validate existence first — returns NotFound cleanly.
        let _ = self.repo.get(playbook_id).await?;
        self.repo.compute_analytics(playbook_id).await
    }
    ...
    pub async fn compose_adaptive_from_case(
        ...
        let entries = self.repo.fetch_case_notebook_entries(case_id).await?;
